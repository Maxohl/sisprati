...
router.post('/',validateCondi, isLoggedIn,catchAsync(async(req,res) => {
    ...
    con.query(condicionada,function(err,result,fields){
        ...
        mailCondi.Data = dataRequi + ' ' +caminho.Hora_requi;
        mailCondi.Berco = caminho.berco_requi;  
        mailCondi.Servico = caminho.Requi_servico; 
        mailCondi.Posicao = caminho.posicao_requi; 
        mailCondi.Faturamento = caminho.Fatu_requi;    
        mailCondi.Obs = caminho.Obs_requi; 
        mailCondi.Servico = caminho.Requi_servico;
